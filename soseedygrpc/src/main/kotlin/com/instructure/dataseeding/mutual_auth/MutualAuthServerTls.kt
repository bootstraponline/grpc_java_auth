...
class MutualAuthServerTls(
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            println(
                    "USAGE: MutualAuthServerTls host port certChainFilePath privateKeyFilePath "
            ...
            println("Starting MutualAuthServerTls")

            val server = MutualAuthServerTls(
                    host, port, certChainFilePath, privateKeyFilePath, clientCertChainFilePath)
            server.start()
